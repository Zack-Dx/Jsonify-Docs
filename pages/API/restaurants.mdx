...
fetch('https://jsonify.com/restros')
...
```js filename="demo.js" {3} copy
fetch('https://jsonify.com/restros/123456') // Replace '123456' with the desired restaurant's ID
  .then((response) => response.json())
  .then((data) => console.log(data));
```
...
fetch('https://jsonify.com/restros/123456', {
  method: 'PUT',
  headers: {
    'Content-Type': 'application/json',
  },
